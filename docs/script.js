/* ============================================
   THE WORLDWIDE DOVE — Website Scripts
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Blog filter toggle ---
    document.querySelectorAll('.blog-filter__tag').forEach(tag => {
        tag.addEventListener('click', () => {
            document.querySelectorAll('.blog-filter__tag').forEach(t => t.classList.remove('is-active'));
